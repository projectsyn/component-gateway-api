# Commodore Component: Gateway API

This is a [Commodore][commodore] Component for Gateway API.
...
The rendered documentation for this component is available on the [Commodore Components Hub](https://hub.syn.tools/gateway-api).

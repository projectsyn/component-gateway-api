...
The library also exports two constants: `gatewayApiGroup` contains the API group `gateway.networking.k8s.io`, and `gatewayApiExperimentalGroup` contains the API group `gateway.networking.x-k8s.io` used by experimental-channel-only resources.
